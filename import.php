        ...
        if ($latitude === false || $longitude === false) {
            ...
            if (isset($response['error'])) {
                ...
                if (!empty($climateData)) {
                    $saveResult = saveClimateData($latitude, $longitude, $variable, $climateData, $variableNames, $unitMapping);
                    if ($saveResult === true) {
...
<head>
    ...
    <style>
        ...
        .api-url-display { background-color: #f8f9fa; padding: 10px; border-radius: 5px; border: 1px solid #dee2e6; word-break: break-all; }
        .api-url-display code { font-size: 11px; color: #0066cc; line-height: 1.4; }
        .variable-info { background-color: #e7f3ff; border: 1px solid #b3d9ff; border-radius: 5px; padding: 10px; margin-bottom: 15px; }
        .debug-info { background-color: #fff3cd; border: 1px solid #ffeaa7; border-radius: 5px; padding: 10px; margin-bottom: 15px; }
    </style>
</head>
<body>
